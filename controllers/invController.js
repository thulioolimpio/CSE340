...
// NOVO: Importe o review-utilities
const reviewUtil = require("../utilities/review-utilities") 
...
/* ****************************************
 * Build Vehicle Detail View (Client View) - COM REVIEWS
 * ************************************ */
invCont.buildDetail = async function (req, res, next) {
    try {
        ...
        const vehicle = await invModel.getInventoryById(invId) // Dados do veículo
        if (!vehicle) {
        ...
        // NOVO: Carregar e construir o HTML das Reviews
        const reviewsHTML = await reviewUtil.buildVehicleReviews(invId) 
        ...
        res.render("inventory/detail", {
            ...
            nav,
            detailHTML, 
            vehicle,       // Passa o objeto vehicle para a view (necessário para o formulário de review)
            reviewsHTML,   // <-- NOVO: HTML das avaliações
            review_text: null, // <-- NOVO: Variável sticky para o formulário de review
            errors: null,
        })
    } catch (error) {
        next(error)
